...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-background via-secondary/30 to-background overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      className="p-3 border-2 border-primary/30 rounded-lg hover:bg-gradient-to-r hover:from-primary hover:to-blue-600 hover:text-primary-foreground hover:border-transparent transition-all duration-300 hover:scale-110"
                    >
      ...
      <section className="py-0 bg-background">
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            <div className="aspect-[21/9] bg-secondary/20 rounded-2xl overflow-hidden border-2 border-border/50">
              <iframe
